...
class TestCarrierPackages(CarrierLabelCase):
    ...
    def test_labels_with_packages(self):
        ...
        """
        self.picking.carrier_id.automatic_package_creation_at_delivery_default = True
    ...
    def test_labels_without_packages(self):
        ...
        """
        self.picking.carrier_id.automatic_package_creation_at_delivery_default = False
        self.picking.send_to_shipper()
