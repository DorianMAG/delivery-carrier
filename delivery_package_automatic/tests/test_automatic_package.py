...
class TestAutomaticPackage(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.env.company.automatic_package_creation_default = True
        cls.env.company.invalidate_recordset()
    ...
    def test_automatic_carrier(self):
        ...
        """
        self.assertTrue(self.carrier.automatic_package_creation)
    ...
    def test_automatic_context(self):
        ...
        The move line should contain a package
        """
        self.carrier.automatic_package_creation = False
        picking = self._create_picking()
        picking.move_ids.update({"quantity_done": 5.0})
